/**
 * The Gold Barometer MCP tools (thegoldbarometer.com). Read-only, public
 * JSON data, no key. Registered on any McpServer: the npm stdio server
 * (index.ts) and the hosted endpoint (worker.ts) share this file.
 * Data licence: CC BY 4.0, credit "The Gold Barometer, thegoldbarometer.com".
 */
import type { McpServer } from "@modelcontextprotocol/sdk/server/mcp.js";
import { z } from "zod";

export const SERVER_INFO = { name: "thegoldbarometer", version: "1.1.0" };
...
const UA = "thegoldbarometer-mcp/1.1";
